...
const CONFIG_DIR = path.join(os.homedir(), '.config', 'lyrical');
...
export function saveCookiesTxt(cookieString: string): void {
  ...
  const lines: string[] = ['# Netscape HTTP Cookie File', '# https://curl.haxx.se/docs/http-cookies.html', '# This file was generated by Lyrical CLI', ''];
